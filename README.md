...
**Active open-source contributor to [AMD GAIA](https://github.com/amd/gaia)** — AMD's flagship framework for running generative AI agents locally on Ryzen AI hardware. Shipped a substantial merged feature ([PR #1219](https://github.com/amd/gaia/pull/1219): +2,664 lines across 27 files, approved by the maintainer with *"thorough, well-tested PR"*) adding a per-agent MCP tool-visibility activation system, then filed and fixed two follow-up gaps I found in the connector subsystem ([#1226](https://github.com/amd/gaia/issues/1226)/[PR #1309](https://github.com/amd/gaia/pull/1309), [#1227](https://github.com/amd/gaia/issues/1227)/[PR #1310](https://github.com/amd/gaia/pull/1310)) — production code reviewed and merged into a major hardware vendor's open-source project.
