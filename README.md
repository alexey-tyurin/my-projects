...
**🧠 Procedural-memory implementation** ([PR #1794](https://github.com/amd/gaia/pull/1794), in review, implements spec #1732): the full skill auto-synthesis pipeline (additive v2→v3 schema migration, a `procedures` table, `recall_skill`) with **94 passing tests** and a per-acceptance-criterion proof. The AI reviewer: *"a carefully-built, well-tested procedural-memory tier… No correctness or security blockers."*
