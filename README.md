...
Creator of **[mcp-chaos-monkey](https://github.com/alexey-tyurin/mcp-chaos-monkey)** — the first open-source chaos engineering framework for MCP, shipped with **full feature parity across TypeScript (npm) and Python (PyPI)** — and author of the **[MCP Reliability Playbook](https://github.com/alexey-tyurin/reliable-mcp)** with 9 production resilience patterns and a chaos-testing harness for MCP tool pipelines. Experienced with **autonomous agent design (plan-and-execute, Re-planner loops), self-hosted LLM serving on serverless GPU (vLLM, AWQ quantization, KV-cache tuning, prefix caching), RAG architectures, LangGraph agent orchestration, LLM fine-tuning, and multi-layer content safety** (AWS Bedrock Guardrails, hallucination judges, scope classification). **Published author** in **Google Cloud – Community** on Medium — including the **autonomous-agentic-stack-2026 design log**, a **3-part MCP Reliability Series**, and additional articles on AI agent infrastructure and LLM optimization (9 articles total). **Google Cloud Certified Professional Machine Learning Engineer.**
